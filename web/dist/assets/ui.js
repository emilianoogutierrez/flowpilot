...
export function button(text, action, className = 'button', symbol) {
...
export function field(title, input, hint) {
...
export function textArea(value, rows = 16) {
...
export async function busy(buttonElement, action) {
...
export function graph(nodes) {
    ...
    for (const node of nodes) {
        ...
        const symbols = { set: 'code', condition: 'filter', ai: 'ai', approval: 'team', delay: 'clock', http: 'globe' };
